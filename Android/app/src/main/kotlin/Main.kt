...
internal val logger: SkipLogger = SkipLogger(subsystem = "raven.rewards", category = "RavenRewards")

private typealias AppRootView = RavenRewardsRootView
private typealias AppDelegate = RavenRewardsAppDelegate
